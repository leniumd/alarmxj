...
public class BtcFormatTest {
    ...
    public void characterIteratorTest() {
        ...
        // formatted as "µALRMX 192,463.63"
    ...
    public void parseTest() throws java.text.ParseException {
        ...
        // Coins
        assertEquals(valueOf(200000000), us.parseObject("ALRMX2"));
        ...
        assertEquals(valueOf(200000000), usCoded.parseObject("ALRMX 2"));
        ...
        assertEquals(valueOf(200000000), us.parseObject("ALRMX2.0"));
        ...
        assertEquals(valueOf(202222420000000L), us.parseObject("ALRMX2,022,224.20"));
        ...
        // MilliCoins
        assertEquals(valueOf(200000), usCoded.parseObject("mALRMX 2"));
        ...
        assertEquals(valueOf(200000), us.parseObject("mALRMX2"));
        ...
        assertEquals(valueOf(200000), usCoded.parseObject("₥ALRMX 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥XDC 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥ALRMX 2"));
        ...
        assertEquals(valueOf(202222400000L), us.parseObject("₥ALRMX2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("₥XDC2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("mALRMX2,022,224"));
        ...
        assertEquals(valueOf(202222400000L), usCoded.parseObject("₥ALRMX 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("₥XDC 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("mALRMX 2,022,224"));
        ...
        assertEquals(valueOf(435), us.parseObject("uALRMX4.35"));
        assertEquals(valueOf(435), us.parseObject("uXDC4.35"));
        assertEquals(valueOf(435), us.parseObject("µALRMX4.35"));
        assertEquals(valueOf(435), us.parseObject("µXDC4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uALRMX 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uXDC 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("µALRMX 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("µXDC 4.35"));
        // fractional satoshi; round up
        assertEquals(valueOf(435), us.parseObject("uALRMX4.345"));
        ...
        assertEquals(valueOf(-10), us.parseObject("(µALRMX0.100)"));
    ...
    public void parseMetricTest() throws ParseException {
        ...
        // coin
        assertEquals(parseCoin("1"), cp.parseObject("ALRMX 1.00"));
        assertEquals(parseCoin("1"), sp.parseObject("ALRMX1.00"));
        ...
        // milli
        assertEquals(parseCoin("0.001"), cp.parseObject("mALRMX 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("mALRMX1.00"));
        ...
        assertEquals(parseCoin("0.001"), cp.parseObject("₥ALRMX 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("₥ALRMX1.00"));
        ...
        // micro
        assertEquals(parseCoin("0.000001"), cp.parseObject("uALRMX 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uALRMX1.00"));
        ...
        assertEquals(parseCoin("0.000001"), cp.parseObject("µALRMX 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("µALRMX1.00"));
        ...
        // satoshi
        assertEquals(parseCoin("0.00000001"), cp.parseObject("uALRMX 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("uALRMX0.01"));
        ...
        assertEquals(parseCoin("0.00000001"), cp.parseObject("µALRMX 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("µALRMX0.01"));
        ...
        // cents
        assertEquals(parseCoin("0.01234567"), cp.parseObject("cALRMX 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("cALRMX1.234567"));
        ...
        assertEquals(parseCoin("0.01234567"), cp.parseObject("¢ALRMX 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("¢ALRMX1.234567"));
        ...
        // dekacoins
        assertEquals(parseCoin("12.34567"), cp.parseObject("daALRMX 1.234567"));
        assertEquals(parseCoin("12.34567"), sp.parseObject("daALRMX1.234567"));
        ...
        // hectocoins
        assertEquals(parseCoin("123.4567"), cp.parseObject("hALRMX 1.234567"));
        assertEquals(parseCoin("123.4567"), sp.parseObject("hALRMX1.234567"));
        ...
        // kilocoins
        assertEquals(parseCoin("1234.567"), cp.parseObject("kALRMX 1.234567"));
        assertEquals(parseCoin("1234.567"), sp.parseObject("kALRMX1.234567"));
        ...
        // megacoins
        assertEquals(parseCoin("1234567"), cp.parseObject("MALRMX 1.234567"));
        assertEquals(parseCoin("1234567"), sp.parseObject("MALRMX1.234567"));
    ...
    public void currencyCodeTest() {
        ...
        BtcFormat usCoded = BtcFormat.getCodeInstance(Locale.US);
        assertEquals("µALRMX 0.01", usCoded.format(1));
        assertEquals("ALRMX 1.00", usCoded.format(COIN));

        /* Do not insert unneeded space BEFORE currency-code */
        BtcFormat frCoded = BtcFormat.getCodeInstance(Locale.FRANCE);
        assertEquals("0,01 µALRMX", frCoded.format(1));
        assertEquals("1,00 ALRMX", frCoded.format(COIN));
        ...
        assertEquals("µALRMX 0,01", deCoded.format(1));
        assertEquals("ALRMX 1,00", deCoded.format(COIN));
    }
    ...
    public void autoDecimalTest() {
        ...
        assertEquals("ALRMX 1", codedZero.format(COIN));
        assertEquals("µĐ1,000,000", symbolZero.format(COIN.subtract(SATOSHI)));
        assertEquals("µALRMX 1,000,000", codedZero.format(COIN.subtract(SATOSHI)));
        assertEquals("µĐ1,000,000", symbolZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("µALRMX 1,000,000", codedZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("µĐ999,999", symbolZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("µALRMX 999,999", codedZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("Đ1,000", symbolZero.format(COIN.multiply(1000)));
        assertEquals("ALRMX 1,000", codedZero.format(COIN.multiply(1000)));
        assertEquals("µĐ1", symbolZero.format(Coin.valueOf(100)));
        assertEquals("µALRMX 1", codedZero.format(Coin.valueOf(100)));
        assertEquals("µĐ1", symbolZero.format(Coin.valueOf(50)));
        assertEquals("µALRMX 1", codedZero.format(Coin.valueOf(50)));
        assertEquals("µĐ0", symbolZero.format(Coin.valueOf(49)));
        assertEquals("µALRMX 0", codedZero.format(Coin.valueOf(49)));
        assertEquals("µĐ0", symbolZero.format(Coin.valueOf(1)));
        assertEquals("µALRMX 0", codedZero.format(Coin.valueOf(1)));
        assertEquals("µĐ500,000", symbolZero.format(Coin.valueOf(49999999)));
        assertEquals("µALRMX 500,000", codedZero.format(Coin.valueOf(49999999)));

        assertEquals("µĐ499,500", symbolZero.format(Coin.valueOf(49950000)));
        assertEquals("µALRMX 499,500", codedZero.format(Coin.valueOf(49950000)));
        assertEquals("µĐ499,500", symbolZero.format(Coin.valueOf(49949999)));
        assertEquals("µALRMX 499,500", codedZero.format(Coin.valueOf(49949999)));
        assertEquals("µĐ500,490", symbolZero.format(Coin.valueOf(50049000)));
        assertEquals("µALRMX 500,490", codedZero.format(Coin.valueOf(50049000)));
        assertEquals("µĐ500,490", symbolZero.format(Coin.valueOf(50049001)));
        assertEquals("µALRMX 500,490", codedZero.format(Coin.valueOf(50049001)));
        assertEquals("µĐ500,000", symbolZero.format(Coin.valueOf(49999950)));
        assertEquals("µALRMX 500,000", codedZero.format(Coin.valueOf(49999950)));
        assertEquals("µĐ499,999", symbolZero.format(Coin.valueOf(49999949)));
        assertEquals("µALRMX 499,999", codedZero.format(Coin.valueOf(49999949)));
        assertEquals("µĐ500,000", symbolZero.format(Coin.valueOf(50000049)));
        assertEquals("µALRMX 500,000", codedZero.format(Coin.valueOf(50000049)));
        assertEquals("µĐ500,001", symbolZero.format(Coin.valueOf(50000050)));
        assertEquals("µALRMX 500,001", codedZero.format(Coin.valueOf(50000050)));
        ...
        assertEquals("ALRMX 1.00", codedTwo.format(COIN));
        assertEquals("µĐ999,999.99", symbolTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("µALRMX 999,999.99", codedTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("Đ1,000.00", symbolTwo.format(COIN.multiply(1000)));
        assertEquals("ALRMX 1,000.00", codedTwo.format(COIN.multiply(1000)));
        assertEquals("µĐ1.00", symbolTwo.format(Coin.valueOf(100)));
        assertEquals("µALRMX 1.00", codedTwo.format(Coin.valueOf(100)));
        assertEquals("µĐ0.50", symbolTwo.format(Coin.valueOf(50)));
        assertEquals("µALRMX 0.50", codedTwo.format(Coin.valueOf(50)));
        assertEquals("µĐ0.49", symbolTwo.format(Coin.valueOf(49)));
        assertEquals("µALRMX 0.49", codedTwo.format(Coin.valueOf(49)));
        assertEquals("µĐ0.01", symbolTwo.format(Coin.valueOf(1)));
        assertEquals("µALRMX 0.01", codedTwo.format(Coin.valueOf(1)));
        ...
        assertEquals("ALRMX 1.000", codedThree.format(COIN));
        assertEquals("µĐ999,999.99", symbolThree.format(COIN.subtract(SATOSHI)));
        assertEquals("µALRMX 999,999.99", codedThree.format(COIN.subtract(SATOSHI)));
        assertEquals("Đ1,000.000", symbolThree.format(COIN.multiply(1000)));
        assertEquals("ALRMX 1,000.000", codedThree.format(COIN.multiply(1000)));
        assertEquals("₥Đ0.001", symbolThree.format(Coin.valueOf(100)));
        assertEquals("mALRMX 0.001", codedThree.format(Coin.valueOf(100)));
        assertEquals("µĐ0.50", symbolThree.format(Coin.valueOf(50)));
        assertEquals("µALRMX 0.50", codedThree.format(Coin.valueOf(50)));
        assertEquals("µĐ0.49", symbolThree.format(Coin.valueOf(49)));
        assertEquals("µALRMX 0.49", codedThree.format(Coin.valueOf(49)));
        assertEquals("µĐ0.01", symbolThree.format(Coin.valueOf(1)));
        assertEquals("µALRMX 0.01", codedThree.format(Coin.valueOf(1)));
    }
    ...
    public void negativeTest() throws Exception {
        assertEquals("-1,00 ALRMX", BtcFormat.getInstance(FRANCE).format(COIN.multiply(-1)));
        assertEquals("ALRMX -1,00", BtcFormat.getInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("Đ -1,00", BtcFormat.getSymbolInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("ALRMX -1.00", BtcFormat.getInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("Đ-1.00", BtcFormat.getSymbolInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("(ALRMX 1.00)", BtcFormat.getInstance(US).format(COIN.multiply(-1)));
        assertEquals("(Đ1.00)", BtcFormat.getSymbolInstance(US).format(COIN.multiply(-1)));
        // assertEquals("ALRMX -१.००", BtcFormat.getInstance(Locale.forLanguageTag("hi-IN")).format(COIN.multiply(-1)));
        assertEquals("ALRMX -๑.๐๐", BtcFormat.getInstance(new Locale("th","TH","TH")).format(COIN.multiply(-1)));
    ...
    public void attributeTest() throws Exception {
        ...
        assertTrue(codePat.contains("ALRMX") && ! codePat.contains("(^|[^Đ])Đ([^Đ]|$)") && ! codePat.contains("(^|[^¤])¤([^¤]|$)"));
        String symPat = BtcFormat.getSymbolInstance(Locale.US).pattern();
        assertTrue(symPat.contains("Đ") && !symPat.contains("ALRMX") && !symPat.contains("¤¤"));

        assertEquals("ALRMX #,##0.00;(ALRMX #,##0.00)", BtcFormat.getCodeInstance(Locale.US).pattern());
    ...
    public void toStringTest() {
        ...
        assertEquals("Auto-format ALRMX #,##0.00;(ALRMX #,##0.00)", BtcFormat.getCodeInstance(Locale.US).toString());
        assertEquals("Auto-format ALRMX #,##0.0000;(ALRMX #,##0.0000)", BtcFormat.getCodeInstance(Locale.US, 4).toString());
        ...
        assertEquals("Auto-format ALRMX#,00Đ;ALRMX-#,00Đ",
                     BtcFormat.builder().style(SYMBOL).locale(GERMANY).pattern("¤¤#¤").build().toString());
        assertEquals("Coin-format ALRMX#,00Đ;ALRMX-#,00Đ",
                     BtcFormat.builder().scale(0).locale(GERMANY).pattern("¤¤#¤").build().toString());
        assertEquals("Millicoin-format ALRMX#.00Đ;ALRMX-#.00Đ",
    ...
    public void patternDecimalPlaces() {
        ...
        assertEquals("Millicoin-format ALRMX #.000;ALRMX -#.000", f.toString());
        assertEquals("mALRMX 1000.000", f.format(COIN));
    }
    ...
    public void builderTest() {
        ...
        assertEquals("ALRMX -1,00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("¤¤##,###.#").scale(3).locale(US).build();
        assertEquals("mALRMX1,000.00", built.format(COIN));
        built = BtcFormat.builder().pattern("¤ ##,###.#").scale(3).locale(US).build();
