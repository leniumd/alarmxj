...
public class MonetaryFormatTest {
    ...
    public void standardCodes() throws Exception {
        assertEquals("ALRMX 0.00", MonetaryFormat.BTC.format(Coin.ZERO).toString());
        assertEquals("mALRMX 0.00", MonetaryFormat.MBTC.format(Coin.ZERO).toString());
        assertEquals("µALRMX 0", MonetaryFormat.UBTC.format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dALRMX 0", MonetaryFormat.UBTC.code(1, "dALRMX").shift(1).format(Coin.ZERO).toString());
    }
    ...
    public void noCode() throws Exception {
        ...
        assertEquals("dALRMX 0", MonetaryFormat.UBTC.noCode().code(1, "dALRMX").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("ALRMX 0.00", MonetaryFormat.BTC.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 ALRMX", MonetaryFormat.BTC.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("ALRMX@0.00", MonetaryFormat.BTC.codeSeparator('@').format(Coin.ZERO).toString());
    }
