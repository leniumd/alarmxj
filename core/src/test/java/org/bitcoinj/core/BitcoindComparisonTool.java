...
/**
 * A tool for comparing the blocks which are accepted/rejected by alarmxd/alarmxj
 * It is designed to run as a testnet-in-a-box network between a single alarmxd node and alarmxj
...
public class BitcoindComparisonTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("USAGE: alarmxjBlockStoreLocation runExpensiveTests(1/0) [port=18444]");
