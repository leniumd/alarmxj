...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 ALRMX", COIN.toFriendlyString());
        assertEquals("1.23 ALRMX", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 ALRMX", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 ALRMX", valueOf(1, 23).negate().toFriendlyString());
    }
