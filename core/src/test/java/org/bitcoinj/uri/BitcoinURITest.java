...
public class BitcoinURITest {
    ...
    public void testConvertToBitcoinURI() throws Exception {
        ...
        assertEquals("alarmx:" + MAINNET_GOOD_ADDRESS, BitcoinURI.convertToBitcoinURI(goodAddress, null, null, null));
        assertEquals("alarmx:" + MAINNET_GOOD_ADDRESS, BitcoinURI.convertToBitcoinURI(goodAddress, null, "", ""));
    ...
    public void testMultiplePaymentProtocolReq() throws Exception {
        BitcoinURI uri = new BitcoinURI(MAINNET,
                "alarmx:?r=https%3A%2F%2Fbitcoincore.org%2F%7Egavin&r1=bt:112233445566");
    ...
    public void testNoPaymentProtocolReq() throws Exception {
        BitcoinURI uri = new BitcoinURI(MAINNET, "alarmx:" + MAINNET_GOOD_ADDRESS);
    ...
    public void testUnescapedPaymentProtocolReq() throws Exception {
        BitcoinURI uri = new BitcoinURI(TestNet3Params.get(),
                "alarmx:?r=https://merchant.com/pay.php?h%3D2a8628fc2fbe");
