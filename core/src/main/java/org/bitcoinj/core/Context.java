...
public class Context {
    ...
    // Alarmx Specific
    //
    private boolean initializedAlarmx = false;
    public void initAlarmx(boolean liteMode, boolean allowInstantX) {
        ...
        initializedAlarmx = true;
    }

    public void closeAlarmx() {
        //Alarmx Specific
        sporkManager = null;
        ...
        initializedAlarmx = false;
    }

    public void initAlarmxSync(String directory)
    {
