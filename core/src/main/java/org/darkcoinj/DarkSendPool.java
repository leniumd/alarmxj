    ...
    */
    ...
    class ThreadCheckDarkSendPool implements Runnable {
        ...
        public void run() {
            ...
            //RenameThread("alarmx-darksend");
            log.info("--------------------------------------\nstarting alarmx-darksend thread");
            int tick = 0;
            try {
    ...
    public boolean startBackgroundProcessing()
    {
        if(backgroundThread == null)
        {
            ...
            backgroundThread = new ContextPropagatingThreadFactory("alarmx-privatesend").newThread(threadCheckDarkSendPool);
